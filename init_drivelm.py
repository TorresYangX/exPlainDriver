...
from utils_drivelm import data_prepare, train_pipeline
...
if __name__ == "__main__":    
    ...
    data_prepare(conversation_path, question_path, detect_save_path, 
                 vector_save_path, condition_vector_save_path, 
                 llm_prediction_path)
