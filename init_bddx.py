...
from utils import data_prepare, train_pipeline
import json

if __name__ == "__main__":    
    # eval_filled_rag_top2_v8, eval_filled, train_filled_rag_top2_v8, train_filled
    pattern = 'train_filled_rag_top2_v8'
    ...
    vector_data_path = 'process_data/{}/vectors.pkl'.format(pattern)
    llm_prediction_path = 'result/{}/LLM_result.json'.format(pattern)
    weight_save_path = 'optimal_weights_bddx.npy'    
